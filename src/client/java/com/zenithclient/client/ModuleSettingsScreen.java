...
public final class ModuleSettingsScreen extends Screen {
    public enum Type { PLAYER, ENTITY, ITEM, PROJECTILE, BLOCKS, TRAJECTORY, XRAY, FLIGHT, SPEED, AUTO_SPRINT, NO_SLOW, NO_STUN, NO_FALL, CRITICALS, AUTO_TOTEM, ATTRIBUTE_SWAP, KILL_AURA, REACH, INFINITE_REACH, MACE_KILL, SUPER_PUNCH, AIR_JUMP, FREECAM, FULLBRIGHT, FPS, COORDINATES }
    ...
    private int baseOptionCount() {
        return switch (type) {
            ...
            case XRAY -> 3; case FLIGHT -> 3; case ATTRIBUTE_SWAP, SPEED, REACH, MACE_KILL, SUPER_PUNCH, FREECAM -> 2; case KILL_AURA -> 4; case INFINITE_REACH -> 1; default -> 0;
        };
    }
